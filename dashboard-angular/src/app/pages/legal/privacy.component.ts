    ...
    <div class="bg-white py-12 md:py-20 min-h-screen">
      <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="prose prose-cyan text-slate-600 max-w-none">
          ...
          <p>Project JalDrishti ("we", "our", "us") is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and share information when you use our environmental intelligence platform and IoT monitoring services, in compliance with the Digital Personal Data Protection (DPDP) Act and GDPR.</p>
          ...
          <ul>
            ...
            <li>Maintaining the security and stability of the JalDrishti API.</li>
          </ul>
          ...
          <h3>6. Contact Us</h3>
          <p>If you have any questions about this Privacy Policy, please contact us at <a href="mailto:privacy@jaldrishti.org">privacy&#64;jaldrishti.org</a>.</p>
        </div>
      </div>
    </div>
  `
...
export class PrivacyComponent implements OnInit {
  ...
  ngOnInit() {
    this.seoService.updateMetaTags({
      ...
      description: 'Project JalDrishti Privacy Policy detailing GDPR and DPDP compliance regarding telemetry data and user information.',
      canonicalUrl: 'https://jaldrishti.org/privacy'
    });
  }
}
