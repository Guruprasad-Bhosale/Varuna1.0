            ...
            <div class="space-y-6">
              ...
              <div class="flex items-start">
                ...
                <div class="ml-4">
                  ...
                  <p class="text-slate-600 mt-1"><a href="tel:+918001234567" class="text-teal-600 hover:underline">+91 800-123-4567</a></p>
            ...
            <form [formGroup]="contactForm" (ngSubmit)="onSubmit()" class="space-y-4">
              <div>
                ...
                <input type="text" id="name" formControlName="name" 
                  class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 sm:text-sm py-2 px-3 border outline-none"
              ...
              <div>
                ...
                <textarea id="message" rows="4" formControlName="message" 
                  class="mt-1 block w-full rounded-md border-slate-300 shadow-sm focus:border-teal-500 focus:ring-teal-500 sm:text-sm py-2 px-3 border outline-none resize-none"
              ...
              <div class="pt-2">
                <button type="submit" [disabled]="isSubmitting"
                  class="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-bold text-white bg-teal-600 hover:bg-teal-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 transition disabled:opacity-70 disabled:cursor-not-allowed">
