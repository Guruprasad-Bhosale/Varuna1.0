  ...
  template: `
    <div class="bg-slate-50 min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div class="max-w-md w-full text-center bg-white p-10 rounded-3xl shadow-xl border border-slate-100">
        ...
        <p class="text-slate-600 mb-8">Thank you for your interest in Project VARUNA. Our engineering team will review your deployment requirements and contact you within 24 hours.</p>
...
export class ThankYouComponent implements OnInit {
  ...
  ngOnInit() {
    this.seoService.updateMetaTags({
      title: 'Thank You',
      description: 'Your inquiry has been received by the VARUNA team.',
      canonicalUrl: 'https://varuna-iot.org/thank-you'
    });
  }
}
