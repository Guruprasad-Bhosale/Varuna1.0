...
export class SeoService {
  ...
  updateMetaTags(config: SeoConfig): void {
    // 1. Set Title
    const fullTitle = `${config.title} | Project VARUNA Environmental Intelligence`;
    ...
    this.metaService.updateTag({ property: 'og:image', content: config.ogImage || '/assets/images/varuna-og-banner.webp' });
